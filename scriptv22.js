...
$(document).ready(function () {
    ...
    noUiSlider.create(rangeSlider, single {
        start: [3],
        connect: [true, false],
        range: {
            'min': 0,
    ...
    var rangeSlider = document.getElementById('slider-single');
    ...
    function updateExtraTime() {
        ...
        var sliderValue = Number(rangeSlider.noUiSlider.get());
    ...
    rangeSlider.noUiSlider.on('update', updateExtraTime);
