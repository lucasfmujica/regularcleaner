...
$(document).ready(function() {
  ...
  var howOftenSelect = document.getElementById('How-often');
  ...
  function updateExtraTime() {
    ...
    switch(howOftenSelect.value) {
      ...
      case "Twice in a month":
        costPerHour = 16;
        break;
      default: // This covers the case where "Every Week" is selected
        costPerHour = 15;
        break;
    }
...
$(document).ready(function() {
    ...
    function updateOftenDisplay() {
      ...
      // Update the text of all price display elements
